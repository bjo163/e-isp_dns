...
type AdminUser struct {
	...
	MustChangePassword bool      `gorm:"default:false" json:"must_change_password"` // true for default admin/admin
	UpdatedAt          time.Time `json:"updated_at"`
}

// WhitelistedDomain is a domain that must never be blocked — even if present
// in an imported blocklist. Common uses: google.com, ISP domains, critical infra.
